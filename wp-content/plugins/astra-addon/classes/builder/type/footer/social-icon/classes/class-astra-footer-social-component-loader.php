...
class Astra_Footer_Social_Component_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-social-icon-addon-footer-customizer-preview-js', ASTRA_FOOTER_SOCIAL_URI . '/assets/js/customizer-preview.js', array( 'customize-preview', 'ahfb-addon-base-customizer-preview' ), ASTRA_EXT_VER, true );
